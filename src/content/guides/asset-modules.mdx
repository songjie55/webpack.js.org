...
所有 `.png` 文件都将被发送到输出目录，并且其路径将被注入到 bundle 中，除此之外，你可以为它们自定义 [`outputPath`](/configuration/module/#rulegeneratoroutputpath) 和 [`publicPath`](/configuration/module/#rulegeneratorpublicpath) 属性。
...
如果你想把原始资源排除在其他 loader 的处理范围以外，请使用取反的正则：
